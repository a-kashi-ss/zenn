...
主題とは異なりますが、関連性が高いサービスを2つ補足情報として記載しておきます。

### 5-1. ロードバランサー

:::details 📝ロードバランサーの役割。

参照元：[AWSのロードバランサーとは？ その役割・種類と料金について](https://www.cloudsolution.tokai-com.co.jp/white-paper/2021/0830-251.html#anc-01)
